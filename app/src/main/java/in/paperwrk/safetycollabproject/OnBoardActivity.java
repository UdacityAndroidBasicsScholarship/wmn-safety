...
public class OnBoardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!introManager.check()) {
            ...
            Intent i = new Intent(OnBoardActivity.this, SigninActivity.class);
            startActivity(i);
            finish();
        }
        ...
        layouts = new int[]{R.layout.intro_screen_1, R.layout.intro_screen_2, R.layout.intro_screen_3, R.layout.intro_screen_4};
        addButtonDots(0);

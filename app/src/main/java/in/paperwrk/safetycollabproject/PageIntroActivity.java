...
public class PageIntroActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                R.layout.on_bording_slide1,
                R.layout.on_bording_slide2,
                R.layout.on_bording_slide3,
                R.layout.on_bording_slide4};
...
public class PageIntroActivity extends AppCompatActivity {
    ...
    private void launchHomeScreen() {
        startActivity(new Intent(PageIntroActivity.this, SigninActivity.class));
        finish();
    }
